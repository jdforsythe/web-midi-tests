...
const coreDebug = (0, debug_1.default)('spherov2-core');
// TS workaround until 2.8 (not released), then ReturnType<factory>
exports.commandsType = false && (0, commands_1.factory)();
exports.decodeType = false && (0, decoder_1.factory)((_) => null);
var Event;
(function (Event) {
...
class Core {
    ...
    async start() {
        ...
        await (0, utils_1.toPromise)(this.dfuControlCharacteristic, this.dfuControlCharacteristic.subscribe);
        coreDebug('start-apiV2Characteristic-subscribe');
        await (0, utils_1.toPromise)(this.apiV2Characteristic, this.apiV2Characteristic.subscribe);
    ...
    async appVersion() {
        ...
        return {
            major: (0, decoder_1.number)(response.command.payload, 1),
            minor: (0, decoder_1.number)(response.command.payload, 3),
        };
    }
    ...
    async destroy() {
        ...
        await (0, utils_1.toPromise)(this.peripheral, this.peripheral.disconnect);
    }
    async configureSensorStream() {
        ...
        this.sensorMask = (0, utils_2.sensorValuesToRaw)(sensorMask, this.apiVersion);
        await this.queueCommand(this.commands.sensor.sensorMask((0, utils_2.flatSensorMask)(this.sensorMask.v2), types_2.SensorControlDefaults.interval));
        if (this.sensorMask.v21.length > 0) {
            await this.queueCommand(this.commands.sensor.sensorMaskExtended((0, utils_2.flatSensorMask)(this.sensorMask.v21)));
        }
    }
    ...
    async init() {
        ...
        this.commands = (0, commands_1.factory)();
        this.decoder = (0, decoder_1.factory)((error, packet) => this.onPacketRead(error, packet));
        this.started = false;
        coreDebug('init-connect');
        await (0, utils_1.toPromise)(p, p.connect);
        coreDebug('init-discoverAllServicesAndCharacteristics');
        await (0, utils_1.toPromise)(p, p.discoverAllServicesAndCharacteristics);
        // WEB
    ...
    handleSensorUpdate(command) {
        ...
        if (handler) {
            const parsedEvent = (0, utils_2.parseSensorEvent)(command.payload, this.sensorMask);
            handler(parsedEvent);
        }
        else {
            console.log('No handler for collision but collision was detected');
    ...
    write(c, data) {
        ...
        return (0, utils_1.toPromise)(c, c.write, [buff, true]);
    }
}
exports.Core = Core;

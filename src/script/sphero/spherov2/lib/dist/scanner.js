...
const scannerDebug = (0, debug_1.default)('spherov2-scanner');
...
const findToys = async (toysType) => {
    ...
    await (0, utils_2.toPromise)(noble_wrapper_1.default, noble_wrapper_1.default.startScanning, [
    ...
    await (0, utils_2.toPromise)(noble_wrapper_1.default, noble_wrapper_1.default.stopScanning);
...
const find = async (toyType, name) => {
    const discovered = await (0, exports.findToys)([toyType]);
...
const findBB9E = async () => {
    return (await (0, exports.find)(bb9e_1.BB9E.advertisement));
};
...
const findR2D2 = async () => {
    return (await (0, exports.find)(r2d2_1.R2D2.advertisement));
};
...
const findR2Q5 = async () => {
    return (await (0, exports.find)(r2q5_1.R2Q5.advertisement));
};
...
const findSpheroMini = async () => {
    return (await (0, exports.find)(sphero_mini_1.SpheroMini.advertisement));
};
...
const findSpheroMiniByName = async (name) => {
    return (await (0, exports.find)(sphero_mini_1.SpheroMini.advertisement, name));
};
...
const findAllSpheroMini = async () => {
    return (await (0, exports.findAll)(sphero_mini_1.SpheroMini.advertisement));
};
...
const findLightningMcQueen = async () => {
    return (await (0, exports.find)(lightning_mcqueen_1.LightningMcQueen.advertisement));
};
